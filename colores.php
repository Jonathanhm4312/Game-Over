...
<body style="background: url('img/f4.jpg') no-repeat center center fixed; background-size: cover;">
    ...
    <h4>
        Arrastra el color correcto al cuadro
    </h4>
	...
	var Pokemons = ["azul","blanco","cafe","celeste","gris","morado","naranja","negro","rojo","rosado","verde"];
    ...
    $(document).ready(function(){ IniciarJuego();});
        ...
        function IniciarJuego(){
            Pokemons = ["azul","blanco","cafe","celeste","gris","morado","naranja","negro","rojo","rosado","verde"];
            PokemonsJuego = [];
            indice=0;
            item=0;
        ...
        item = PokemonsJuego[indice];
           ...
           $.each(PokemonsJuego, function( i, val ) {
            ...
            $("#pokemons").append('<div class="col-xs-4 col-md-4" ><a href="#" class="thumbnail"><img src="colores/'+val+'.jpeg" id='+val+' draggable="true" ondragstart="drag(event)" style="cursor:move" /></a></div>');
